function readIncarichiTemplate(data, keywords) {
    var incarichi_html = `
        <div class="btn-group margin-bottom-1em" role="group" aria-label="...">
            <button id="nuovi-incarichi" type="button" class="btn btn-default active">Nuovi incarichi</button>
            <button id="completa-incarichi" type="button" class="btn btn-default">Miei incarichi</button>
        </div>
        ...
        <div id='accetta-incarico' class='btn btn-primary pull-right m-b-15px accetta-incarico-button'>
            <span class='glyphicon glyphicon-plus'></span> Accetta incarico
        </div>
